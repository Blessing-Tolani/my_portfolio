...
export default function HomePage() {
  return (
    <section className="px-5 md:px-12 w-full xl:px-32 text-white relative">
      <Header />
      <div className="py-10">
        ...
        <p className="text-4xl md:text-5xl leading-tight text-gray mt-4 md:w-10/12 xl:w-3/4 font-dm-sans ">
          I'm Blessing,{' '}
          <span className="text-white font-playfair italic">
            A Frontend Engineer
          </span>{' '}
          <span>
            with specialty in building{' '}
            <span className="text-white italic font-playfair">websites</span>{' '}
            and{' '}
            <span className="text-white italic font-playfair">
              web applications
            </span>
          </span>
        </p>
